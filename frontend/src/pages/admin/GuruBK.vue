        ...
        <div class="bg-white rounded-xl shadow-md border border-gray-200 overflow-x-auto">
          <table class="w-full text-left min-w-full">
            <thead class="bg-gray-50 border-b border-gray-200">
              <tr>
                <th class="py-3 px-5 text-sm font-semibold text-gray-600 w-12">
                  No
                </th>
            ...
            <tbody>
              ...
              >
                ...
                <td class="py-3 px-5 text-sm text-gray-700 font-mono">
                  {{ item.nip }}
                </td>
                <td class="py-3 px-5 text-sm text-gray-700 font-bold">
                  {{ item.nama }}
                </td>
    ...
    >
      <div class="bg-white w-full max-w-md p-6 rounded-xl shadow-xl relative">
        ...
        <h3 class="text-lg font-bold mb-5 text-gray-800">
          {{ isEdit ? "Edit Guru BK" : "Tambah Guru BK" }}
        </h3>
  ...
  methods: {
    ...
    async save() {
      ...
      try {
        if (this.isEdit) {
          ...
          this.$refs.toast.show("Guru BK berhasil diperbarui!", "success");
        } else {
          await axios.post(API_URL, this.form, this.getAuthConfig());
          this.$refs.toast.show("Guru BK berhasil ditambahkan!", "success");
        }
        this.showForm = false;
        this.getData();
      } catch (e) {
    ...
    async remove(id) {
      ...
      try {
        ...
        this.$refs.toast.show("Guru BK berhasil dihapus!", "success");
        this.getData();
      } catch (e) {

    ...
    >
      <div class="relative z-50 bg-[#0057A8] h-full flex flex-col">
        ...
        <nav class="flex-1 w-full mt-10 px-4">
          <ul class="space-y-3">
            <li>
              <router-link to="/admin" class="nav-link nav-link-active">
            ...
            <li>
              <router-link to="/admin/siswa" class="nav-link">
    ...
    <div class="flex-1 flex flex-col h-screen overflow-y-auto">
      <header class="sticky top-0 bg-white border-b border-gray-200 z-30">
        <div class="px-4 md:px-8 h-16 flex items-center justify-between">
          <button @click="openSidebar = true" class="md:hidden p-1 text-gray-700">
      ...
      <main class="flex-1 p-4 md:p-8">
        ...
        <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div class="bg-gradient-to-br from-purple-100 to-indigo-100 p-6 rounded-xl shadow-md border border-purple-200">
          ...
          <div class="bg-gradient-to-br from-orange-100 to-amber-100 p-6 rounded-xl shadow-md border border-orange-200">
            <div class="flex items-center justify-between">
          ...
          <div class="bg-gradient-to-br from-green-100 to-emerald-100 p-6 rounded-xl shadow-md border border-green-200">
            <div class="flex items-center justify-between">
          ...
          <div class="bg-gradient-to-br from-blue-100 to-cyan-100 p-6 rounded-xl shadow-md border border-blue-200">
            <div class="flex items-center justify-between">
              ...
              <ul v-if="aktivitas.length > 0" class="space-y-2 mt-2">
                ...
                >
                  ...
                  <div class="hidden md:block md:col-span-6">
                    ...
                    <p v-if="log.details" class="text-xs text-gray-500 truncate" :title="log.details">
                      {{ log.details }}
                    </p>
                  </div>
...
import {
  HomeIcon, UserGroupIcon, AcademicCapIcon, BookOpenIcon, UsersIcon,
  ArrowLeftOnRectangleIcon, Bars3Icon, XMarkIcon, ClipboardDocumentCheckIcon,
...
export default {
  components: {
    Avatar, HomeIcon, UserGroupIcon, AcademicCapIcon, BookOpenIcon, UsersIcon,
    ArrowLeftOnRectangleIcon, Bars3Icon, XMarkIcon, ClipboardDocumentCheckIcon,
  },
  data() {
    return {
  ...
  methods: {
    ...
    async fetchStats() {
      try {
        ...
        // PENGGABUNGAN LOGIKA: Menggunakan endpoint 'dashboard' yang efisien
        // Tapi tetap mengisi variabel 'stats' dan 'aktivitas' agar tampilan tidak berubah
